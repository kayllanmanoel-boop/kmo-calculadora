const CACHE='kmo-driver-v10-identidade-visual';
const ASSETS=['./','./index.html','./styles.css','./geo.css','./app.js','./app-core.js','./payments.js','./branding.js','./manifest.json','./kmo-logo-app.webp','../logo-kmo.png'];
