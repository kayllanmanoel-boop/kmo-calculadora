const CACHE='kmo-driver-v8-identidade-kmo';
const ASSETS=['./','./index.html','./styles.css','./geo.css','./app.js','./app-core.js','./payments.js','./ui-brand.js','./manifest.json','../logo-kmo.png'];
